...
struct VertexOutputForwardBase
{
    ...
    UNITY_VERTEX_OUTPUT_STEREO																			// ------------------------- DiCE -------------------------
	float4 screenPos : TEXCOORD9;																		// We need the screen position to fade out on screen edges where vision doesn't overlap.
};																										// The method used is to calculate screenPos in vertex and then pass it to fragment.
